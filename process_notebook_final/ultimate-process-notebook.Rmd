...
```{r tw-uni-20, echo=T, message=FALSE, warning=FALSE}
...
```{r tw-bi-21, eval=T, echo=T, message=FALSE, warning=FALSE}
...
```{r tw-bi-20, echo=T, message=FALSE, warning=FALSE, eval=T}
...
```{r tw-senti-top-15, echo=T, message=FALSE, warning=FALSE, fig.width=12, fig.height=10}
library(patchwork)
...
### **Pie chart for NRC emotions and its proportion in 2021**
...
### **Pie chart for NRC emotions and its proportion in 2020**
...
The bivariate relationship between extraversion, perceived Support, Perceived Stress, Loneliness is reported in the survey. Perceived stress tends to decrease with support and increases with loneliness. Overall, the level of stress remained higher in women compared to men throughout the period under consideration.
