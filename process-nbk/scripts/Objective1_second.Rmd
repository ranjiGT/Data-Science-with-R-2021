...
d %>% 
  ...
  nrow()
```
644 people have marked Consent as "No". We will filter now only those records for which consent is "Yes" and use them for our analysis
...
We have picked those countries in which the Corona cases were high. You can use glimpse(d$Country) to see all the countrries present in the data set and pick your own country which you want to visualize by editing the countries name in the code.
...
## World Map of corona counteries
